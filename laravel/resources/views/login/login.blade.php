	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
					...
					<div class="login100-form-title" style="background-image: url('http://mooresrowland-asiapac.com/memberarea/img/MR AP logo 1.png');background-size: cover; background-repeat:no-repeat;background-size:60%;">

					</div>
				</div>

				<form class="login100-form validate-form" role="form" method="POST" action="/memberarea/postLogin" >
					{{ csrf_field() }}
